...
public class StudentsProvider extends ContentProvider {
    static final String PROVIDER_NAME = "com.verma.mobile.android.demo.day2.provider.StudentsProvider";
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)){
             ...
             */
            case STUDENTS:
                return "vnd.android.cursor.dir/vnd.demo.students";
            /**
             * Get a particular student
             */
            case STUDENT_ID:
                return "vnd.android.cursor.item/vnd.demo.students";
            default:
